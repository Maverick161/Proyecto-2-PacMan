...
void Ghost::draw(bool i_flash, RenderWindow& i_window)
{
    ...
    Texture texture;
    texture.loadFromFile("/home/fernando/Documentos/Pruebas/PuckMan/Images/Ghost16.png");
...
void Ghost::update(unsigned char i_level, array<array<Cell, MAP_HEIGHT>, MAP_WIDTH>& i_map, Ghost& i_ghost_0, Pacman& i_pacman)
{
    ...
    if (0 == frightened_mode && i_pacman.get_energizer_timer() > 0) // en lugar de i_pacman.get_energizer_timer() == ENERGIZER_DURATION / pow(2, i_level)
    {
